try:
    ...
    raise ImportError("Import json Module Not Found!\npipenv install json")

import six
from telebotapi import util


# Initial override to_json.
...
# Message
# Fetch Message info and make updated to offset.
...
# Fetch ReplyKeyboardRemove info.
...
# Fetch ReplyKeyboardMarkup info.
...
# Fetch InlineKeyboardMarkup info.
...
# Fetch InlineKeyboardButton info.
...
# Fetch InputTextMessageContent info.
...
# Fetch InputLocationMessageContent info.
...
# Fetch InputVenueMessageContent info.
...
# Fetch InputContactMessageContent info.
...
# Fetch InlineQueryResultArticle info.
...
# Fetch InlineQueryResultPhoto info.
class InlineQueryResultPhoto(JsonSerializable):
    def __init__(self, id, photo_url, thumb_url, photo_width=None, photo_height=None, title=None,
        ...
        Represents a link to a photo.
         ...
         description: Short description of the result.
         caption: Caption of the photo to be sent, 0-200 characters.
         parse_mode: Send Markdown or HTML, if you want Telegram apps to show bold, italic, fixed-width text or
...
# Fetch InlineQueryResultGif info.
class InlineQueryResultGif(JsonSerializable):
    def __init__(self, id, gif_url, thumb_url, gif_width=None, gif_height=None, title=None, caption=None,
        ...
        Represents a link to an animated GIF file.
         ...
         title: Title for the result.
         caption:  Caption of the GIF file to be sent, 0-200 characters
         reply_markup: InlineKeyboardMarkup : Inline keyboard attached to the message
         input_message_content: InputMessageContent : Content of the message to be sent instead of the photo
        :return:
        """
...
# Fetch InlineQueryResultMpeg4Gif info.
class InlineQueryResultMpeg4Gif(JsonSerializable):
    def __init__(self, id, mpeg4_url, thumb_url, mpeg4_width=None, mpeg4_height=None, title=None, caption=None,
        ...
        Represents a link to a video animation (H.264/MPEG-4 AVC video without sound).
         ...
         title: Title for the result
         caption: Caption of the MPEG-4 file to be sent, 0-200 characters
         parse_mode: Send Markdown or HTML, if you want Telegram apps to show bold, italic, fixed-width text
...
# Fetch InlineQueryResultVideo info.
...
# Fetch InlineQueryResultAudio info.
...
# Fetch InlineQueryResultVoice info.
...
# Fetch InlineQueryResultDocument info.
...
# Fetch InlineQueryResultLocation info.
...
# Fetch InlineQueryResultVenue info.
...
# Fetch InlineQueryResultContact info.
...
# Fetch BaseInlineQueryResultCached info.
...
# Fetch InlineQueryResultCachedPhoto info.
...
# Fetch InlineQueryResultCachedGif info.
...
# Fetch InlineQueryResultCachedMpeg4Gif info.
...
# Fetch InlineQueryResultCachedSticker info.
...
# Fetch InlineQueryResultCachedDocument info.
...
# Fetch InlineQueryResultCachedVideo info.
...
# Fetch InlineQueryResultCachedVoice info.
...
# Fetch InlineQueryResultCachedAudio
...
# Games
# Fetch InlineQueryResultGame info.
...
# Fetch InputMediaAnimation info.
